...
![Continuous Integration](https://github.com/koromerzhin/template-joomla/workflows/Continuous%20Integration/badge.svg?branch=develop)<!-- ALL-CONTRIBUTORS-BADGE:START - Do not remove or modify this section -->
...
Feel free to check [issues page](https://github.com/koromerzhin/template-joomla/issues).
You can also take a look at the [contributing guide](
    https://github.com/koromerzhin/template-joomla/blob/develop/CONTRIBUTING.md
    ).
...
This project is [MIT](
    https://github.com/koromerzhin/template-joomla/blob/develop/LICENSE
    ) licensed.
